    ...
    private void fetchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fetchBtnActionPerformed
        ...
        if (choise !=0) {
            ...
            if (succ) {
                ...
                responseGDP = api.getDataGDP(url1);
                responseBP = api.getDataBP(url2);
